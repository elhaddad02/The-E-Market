    ...
    @section('home')
        <div class="row">
            ...
            <div class="iconPanier">
                ...
                @endauth
                <button name="ville" value="tanger"><a href="/panier"><i class="fa-solid fa-cart-shopping"></i></a></button>
                <div class="dropdown2">
        ...
        <!-- les boutiques -->
            <ul class="boutiques">
                ...
                <li><a href="">Boutique Tanger</a></li>
        ...
        <div class="cover">
            <img src="images/tangerBack.jpeg" alt="">
        </div>
    @show
    @section('content')
        <div class="femme">
